...
public class JDBCWeatherDAO implements WeatherDAO {
	...
	public String constructRecommendation(Weather weather) {
		...
		String recommendation = tempRecommendation.contentEquals("") && weatherRecommendation.equals("")
				? "It should be a wonderful day to visit the park! Enjoy!"
				: tempRecommendation + weatherRecommendation;
